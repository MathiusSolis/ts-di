...
let AsyncContainer = (() => {
    ...
    return _a = class AsyncContainer {
        ...
        (() => {
            ...
            _container_decorators = [InjectContainer_1.InjectContainer];
            __esDecorate(null, null, _container_decorators, { kind: "field", name: "container", static: false, private: false, access: { has: obj => "container" in obj, get: obj => obj.container, set: (obj, value) => { obj.container = value; } }, metadata: _metadata }, _container_initializers, _instanceExtraInitializers);
